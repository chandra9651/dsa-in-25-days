...
class NodeRtmpSession extends EventEmitter {
  constructor(config, socket) {
    ...
    this.on('connect', this.onConnect); // publisher connect 
    this.on('publish', this.onPublish); // publisher publish stream
    this.on('play', this.onPlay);    // viewer play stream
  ...
  * handleData() {
    ...
    while (this.isStarting) {
      ...
      // @@@ chunk streamID basis header type
      ...
      // @@ formate type  | Type 0 (11 bytes) || Type 1 (7 bytes) || Type 2 (3 bytes) | Type 3 (0 byte) | else - Unknown format type
